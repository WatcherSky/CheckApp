...
class CountryCell: UICollectionViewCell {
    ...
    private lazy var arrowImageView: UIImageView = {
        let imageView = UIImageView(image: UIImage(resource: .arrowDown).withRenderingMode(.alwaysTemplate))
    ...
    func configure(with country: CountriesListModel) {
    ...
    private func configureView() {
        ...
        topContainer.backgroundColor =  UIColor.utility
